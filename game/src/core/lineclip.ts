...
function intersect(a: number[], b: number[], edge: number, bbox: number[]) {
  return edge & 8
...
function bitCode(p: any[] | null, bbox: number[]) {
  var code = 0;
...
export function polygonclip(points: string | any[], bbox: any) {

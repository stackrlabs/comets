...
const magenta5 = magenta(0.5);
const cyan5 = cyan(0.5);
...
export class Draw {
  ...
  stackr() {
    // link it to the site
    this.text2("Powered by Stackr", this.screen.font.small, (width) => {
      return {
        x: this.screen.width2 - width / 2,
